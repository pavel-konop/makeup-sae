    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 w-full">
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-8">
          {/* Portrait upload */}
          <div className="bg-white border border-[#eeeeee] p-6 rounded-sm">
            <h2 className="text-base font-medium text-[#111111] mb-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>Portrait photo</h2>
            <div className="flex items-start gap-6">
              <div
                className="w-32 h-40 bg-[#f5f0f2] rounded-sm overflow-hidden flex-shrink-0 flex items-center justify-center cursor-pointer border border-dashed border-[#ddd] hover:border-[#c2185b] transition-colors"
                onClick={() => fileInputRef.current?.click()}
              >
                {portraitSrc
                  ? <Image src={portraitSrc} alt="Portrait" width={128} height={160} className="w-full h-full object-cover" unoptimized={!!portraitPreview} />
              ...
              <div className="flex flex-col gap-2 pt-1">
                ...
                <button type="button" onClick={() => fileInputRef.current?.click()}
                  className="text-sm px-4 py-2 border border-[#e0e0e0] rounded-sm text-[#111111] hover:border-[#c2185b] transition-colors w-fit"
          ...
          <div className="flex gap-1 border-b border-[#f0f0f0] pb-0">
            {LANGS.map(({ key, label }) => (
          ...
          {/* Bio fields */}
          <div className="bg-white border border-[#eeeeee] p-6 rounded-sm flex flex-col gap-5">
            ...
            <div>
              <label className="block text-xs font-medium text-[#888888] mb-1.5 tracking-wide uppercase" style={{ fontFamily: "'DM Sans', sans-serif" }}>Bio text</label>
              <textarea
                rows={5}
                ...
                className="w-full px-3 py-2.5 text-sm border border-[#e0e0e0] rounded-sm outline-none focus:border-[#c2185b] transition-colors resize-none"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-[#888888] mb-1.5 tracking-wide uppercase" style={{ fontFamily: "'DM Sans', sans-serif" }}>Philosophy quote</label>
              <input
                type="text"
                ...
                className="w-full px-3 py-2.5 text-sm border border-[#e0e0e0] rounded-sm outline-none focus:border-[#c2185b] transition-colors"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              />
            </div>
          </div>
